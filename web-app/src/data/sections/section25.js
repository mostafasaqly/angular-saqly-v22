...
export default {
  ...
  lessons: [
    'ملخص الدورة — 25 قسم في نقاط',
    'مقارنة Angular v22 مع الإصدارات السابقة',
    'خريطة طريق المطوّر (Junior → Senior)',
    'مشاريع ممارسة مقترحة',
    'مصادر التعلم المتقدمة',
    'مجتمع Angular ومصادر المساعدة',
    'آخر الأخبار في Angular v22',
    'ماذا بعد Angular؟',
  ],
  lessonsEn: [
  ...
  content: [
    { type: 'heading', text: 'ملخص الدورة — 25 قسم في نقاط' },
    {
      ...
      items: [
        ...
        '3-4: المكوّنات والقوالب — metadata، template syntax، data binding',
        ...
        '9-10: الموجّهات والخدمات — Directives، Pipes، DI، inject()',
        '11-12: Routing والنماذج — lazy loading، guards، Signal Forms، Reactive Forms',
        '13-14: RxJS وHTTP — Observables، operators، HttpClient، interceptors',
        '15-16: الحالة والمصادقة — Signals Store، JWT، authGuard، RBAC',
        '17-18: UI والأداء — ViewEncapsulation، CSS Variables، OnPush، @defer، Zoneless',
        '19-20: SSR والاختبار — Hydration، Incremental Hydration، TestBed، Jasmine',
    ...
    { type: 'heading', text: 'خريطة طريق المطوّر (Junior → Senior)' },
    {
      ...
      items: [
        ...
        'Mid: يُصمّم هيكل التطبيق، يُرشد المبتدئين، يُحسّن الأداء',
    ...
    { type: 'heading', text: 'الخلاصة الأهم' },
    {
      ...
      items: [
        ...
        'الاختبارات ليست اختيارية — كل خدمة مهمة تحتاج unit tests على الأقل',
